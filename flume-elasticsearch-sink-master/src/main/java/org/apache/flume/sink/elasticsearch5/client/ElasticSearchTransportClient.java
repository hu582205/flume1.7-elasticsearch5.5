 ...
 * under the License.
 */
package org.apache.flume.sink.elasticsearch5.client;
...
import org.apache.flume.sink.elasticsearch5.ElasticSearchIndexRequestBuilderFactory;
import org.apache.flume.sink.elasticsearch5.ElasticSearchSinkConstants;
import org.apache.flume.sink.elasticsearch5.IndexNameBuilder;
...
//		client = transportClient;
	 ...
	 */
	/*
	 * private void openLocalDiscoveryClient() { logger.info(
	 * "Using ElasticSearch AutoDiscovery mode"); Node node =
	 * NodeBuilder.nodeBuilder().client(true).local(true).node(); if (client !=
	 * null) { client.close(); } client = node.client(); }
	 */
	@Override
