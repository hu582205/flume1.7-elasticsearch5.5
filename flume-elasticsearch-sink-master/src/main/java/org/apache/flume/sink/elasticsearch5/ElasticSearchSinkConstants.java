...
public class ElasticSearchSinkConstants {
     ...
     * should use to determine name of index where the event should be sent.
     */
    public static final String INDEX_NAME_BUILDER_PREFIX = INDEX_NAME_BUILDER + ".";
    ...
    public static final String DEFAULT_SERIALIZER_CLASS = "org.apache.flume.sink.elasticsearch5.ElasticSearchLogStashEventSerializer";

    public static final String DEFAULT_INDEX_NAME_BUILDER_CLASS = "org.apache.flume.sink.elasticsearch5.TimeBasedIndexNameBuilder";
}
